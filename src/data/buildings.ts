...
export const buildings: Building[] = [
  {
    ...
    description: 'Бизнес-лофт класса B+ на территории Александро-Невской Мануфактуры. Дизайнерская отделка в стиле лофт, современные инженерные системы, развитая инфраструктура и прогулочная зона на набережной реки Невы.',
